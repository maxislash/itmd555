...
then
	...
	aws elb create-load-balancer --load-balancer-name androidLB --listeners Protocol=Http,LoadBalancerPort=80,InstanceProtocol=Http,InstancePort=80 --subnets $SUBNET --security-groups $SECURITYGROUP
